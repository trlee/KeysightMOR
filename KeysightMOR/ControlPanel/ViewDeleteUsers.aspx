...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="this_box">       
        ...
        <fieldset>
            <asp:GridView ID="GridView1" runat="server" DataKeyNames="UserID" AutoGenerateColumns="False" EmptyDataText="There are no data records to display." DataSourceID="SqlDataSource1" RowStyle-HorizontalAlign="Center" GridLines="None" Width="978px">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="SELECT U.UserID, U.UserName, U.UserEmail, U.Position, D.DivName
                                       FROM [User] AS U INNER JOIN
                                       UserDivID AS UDI ON U.UserID = UDI.UserID INNER JOIN
                                       Division AS D ON UDI.DivID = D.DivID"
